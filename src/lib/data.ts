...
export const recentPosts: Post[] = [
  {
    ...
    imageUrl: postImage1?.imageUrl,
    imageHint: postImage1?.imageHint,
    likes: 1203,
    comments: 89,
    shares: 45,
    status: 'Published',
  ...
  },
  {
    ...
    imageUrl: postImage2?.imageUrl,
    imageHint: postImage2?.imageHint,
    likes: 874,
    comments: 102,
    shares: 67,
    status: 'Published',
  },
  {
    ...
    imageUrl: postImage4?.imageUrl,
    imageHint: postImage4?.imageHint,
    likes: 2451,
    comments: 341,
    shares: 129,
    status: 'Published',
  },
  {
    ...
    imageUrl: postImage3?.imageUrl,
    imageHint: postImage3?.imageHint,
    likes: 456,
    comments: 34,
    shares: 22,
    status: 'Published',

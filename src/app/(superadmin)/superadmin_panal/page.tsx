...
import { Briefcase, PlayCircle, Rocket, Clock, CheckCircle, Users, IndianRupee } from 'lucide-react';
...
export default function SuperAdminPage() {
  ...
  return (
    <motion.div 
        className="space-y-8 p-4 md:p-8" // Added padding for better spacing on full-screen
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
    >

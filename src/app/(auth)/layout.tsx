...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex flex-col min-h-screen items-center justify-center bg-background overflow-hidden p-4">
      ...
      <div className="absolute -bottom-1/4 -right-1/4 w-96 h-96 bg-accent/10 rounded-full filter blur-3xl opacity-50 animate-pulse delay-2000"></div>

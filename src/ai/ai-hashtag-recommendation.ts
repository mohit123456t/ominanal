...
Please provide 5-10 hashtags that are most relevant to the post content and trending on the specified platform.  Return the hashtags as an array of strings.
`,
});
